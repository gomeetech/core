 ...
 * 
 * @method mixed beforeSave( Request $request, Arr $data, Model $model ) 
 * @method mixed beforeAjaxSave( Request $request, Arr $data ) 
 ...
 * @method mixed beforeAjaxUpdate( Request $request, Arr $data )
